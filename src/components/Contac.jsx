            ...
            <div className="flex flex-col items-center justify-center  mx-auto md:h-screen lg:py-0">
                ...
                <div className="w-full p-6 bg-purple-400 rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
                    ...
                    <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" ref={Form} onSubmit={sendEmail}>
                        <div>
                            <label htmlFor= "text" className="block mb-2 text-sm font-medium text-white dark:text-white">Your name</label>
                        ...
                        <div>
                            <label htmlFor="text" className="block mb-2 text-sm font-medium text-white dark:text-white">Deja tu mensaje</label>
